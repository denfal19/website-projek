...
<table class="table table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="halaman.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('Apakah yakin ingin menghapusnya?')"><span class="badge bg-danger">Delete</span></a>
                <a href="halaman_input.php?id=<?php echo $r1['id']?>"><span class=" badge bg-warning text-dark">Edit</span></a>
            </td>
        </tr>
        <?php
        }
